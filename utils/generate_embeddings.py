...
def generate_umap(backbone, patch_path, num_workers):
    ...
    # pickle.dump(embeddings, open(os.path.join(path_to_data, 'embedding_histossl.p'),"wb"))
    # pickle.dump(filenames, open(os.path.join(path_to_data, 'filenames_histossl.p'), "wb"))
